...
Commands:
  add <name> [--mode <claude-oauth|console|codex|qwen|xai|zai|minimax|anthropic-compatible|openai-compatible|nanogpt|kilo|openrouter|openrouter-anthropic|ollama|ollama-cloud>] [--priority <number>] [--modelMappings <JSON>]
